...
public interface CustomerRepository extends CrudRepository<Customer, Long> {
	...
	public Customer findCustomer(@Param("firstName")  String firstName, @Param("lastName") String lastName, @Param("accountNumber") String accountNumber, @Param("phoneNumber") String phoneNumber, @Param("zipCode") String zipCode, @Param("areaCode") String areaCode);
	...
	public Customer findCustomer(@Param("businessName") String businessName, @Param("accountNumber") String accountNumber, @Param("phoneNumber") String phoneNumber, @Param("zipCode") String zipCode, @Param("areaCode") String areaCode);
